...
namespace RollingOutTools.Storage.WithLiteDB
{
    /// <summary>
    ...
    public class LiteDatabaseLocalStorage : IKeyValueStorage
    {
        ...
        public LiteDatabaseLocalStorage(string collectionName) : this(collectionName, Environment.CurrentDirectory)
        {
            Initialize(
                collectionName, 
                Path.Combine(Environment.CurrentDirectory,DefaultDbFileName)
                );
        }
